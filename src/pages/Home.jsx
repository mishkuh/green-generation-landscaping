...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Green Generation Landscaping - Professional Landscaping Services | Transform Your Outdoor Space</title>
        <meta
          name="description"
          content="Professional landscaping services including landscape design, lawn maintenance, hardscaping, and irrigation systems. Transform your outdoor space with Green Generation Landscaping's expert team."
        />
      </Helmet>
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-900 to-green-700">
          ...
          >
            <img
              ...
              src="https://images.unsplash.com/photo-1610950489322-cb9e8da141da"
            />
          </motion.div>
