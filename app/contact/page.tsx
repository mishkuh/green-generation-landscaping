...
const Contact = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const { email, phone, location, projectDetails, hearAbout } = formData;

        if (!email || !phone || !location || !projectDetails) {
            toast({
        ...
        try {
            ...
            const recipients = ['info@greengenerationlandscaping.com', 'admin@greengenerationlandscaping.com'];
                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="w-full">
                                    {/* Replaced Button component with a styled button compatible with submit type if component doesn't support it well, 
                        assuming ui/button supports it. */}
