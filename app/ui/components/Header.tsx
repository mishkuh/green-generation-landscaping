...
const Header = () => {
    ...
    const logo = "https://horizons-cdn.hostinger.com/9ced1848-2c46-4613-86ab-c57e9e453507/482b06a41551a7b7aede5cc46b743e23.png";
            ...
            <nav className="container mx-auto px-4 py-4">
                <div className="flex items-center justify-between">
                    <Link href="/" className="flex items-center gap-2 group">
                        <div className="bg-green-600 p-2 rounded-full transition-transform group-hover:scale-110">
