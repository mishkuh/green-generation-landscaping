...
import AnimatedWaveFooter from '@/components/AnimatedWaveFooter';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <Link to="/" className="text-stone-400 hover:text-green-500 transition-colors">
                Home
              </Link>
              <Link to="/portfolio" className="text-stone-400 hover:text-green-500 transition-colors">
                Portfolio
              </Link>
              <Link to="/services" className="text-stone-400 hover:text-green-500 transition-colors">
                Services
              </Link>
              <Link to="/about" className="text-stone-400 hover:text-green-500 transition-colors">
                About
              </Link>
              <Link to="/contact" className="text-stone-400 hover:text-green-500 transition-colors">
                Contact
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <Link to="/services/landscape-maintenance" className="text-stone-400 hover:text-green-500 transition-colors">
                Landscape Maintenance
              </Link>
              <Link to="/services/hardscaping" className="text-stone-400 hover:text-green-500 transition-colors">
                Hardscaping
              </Link>
              <Link to="/services/irrigation" className="text-stone-400 hover:text-green-500 transition-colors">
                Irrigation Systems
              </Link>
              <Link to="/services" className="text-stone-400 hover:text-green-500 transition-colors">
                All Services
