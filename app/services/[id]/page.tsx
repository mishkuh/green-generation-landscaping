    ...
    if (!service) {
        return (
            <div className="pt-32 text-center pb-20">
                ...
                <Link href="/services" className="text-green-600 hover:underline">Back to Services</Link>
            </div>
        );
    }
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                        <div className="lg:col-span-2 space-y-12">
                            <div>
                                ...
                                <p className="text-lg text-stone-700 leading-relaxed">{service.detailDescription || service.description}</p>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {service.images && service.images.slice(1).map((image, index) => (
