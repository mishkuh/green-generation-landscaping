...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.email || !formData.phone || !formData.location || !formData.projectDetails) {
      toast({
        title: "Missing Required Fields",
        description: "Please fill in all required fields (email, phone, location, and project details).",
        variant: "destructive"
      });
      return;
    }
    ...
    toast({
      ...
      description: "We'll get back to you within 24 hours. Thank you for contacting Green Generation Landscaping!"
    });
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us - Green Generation Landscaping Landscaping | Get Your Free Consultation</title>
        <meta
          name="description"
          content="Contact Green Generation Landscaping for a free landscaping consultation. Reach out via phone, email, or our contact form to discuss your outdoor project needs."
        />
      </Helmet>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <label htmlFor="projectDetails" className="block text-sm font-semibold text-stone-700 mb-2">
                  ...
                  <div>
                    <label htmlFor="hearAbout" className="block text-sm font-semibold text-stone-700 mb-2">
                  ...
                  <Button type="submit" className="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-3 text-lg">
                    Send Message
